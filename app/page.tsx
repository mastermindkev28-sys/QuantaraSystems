        ...
        <section id="qs-infrastructure" style={{ padding: '130px 48px', background: '#070708' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <div className="qs-grid-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 56 }}>
              {[
                { q: "I run capital for a family with a long investment horizon. We've seen every kind of strategy come through over the years. I came in expecting to find a reason to exit within the first 90 days. Four cycles in and I'm still here. The account behaves the way they said it would. That's the whole story.", name: 'M.R.', role: 'Family Office Allocator' },
                { q: "I'm not a trader and never wanted to be. Someone I trust pointed me here. Setup was straightforward and I handed over the credentials. That was essentially my last real involvement. Payout came in, I requested another cycle. That's been my experience with it.", name: 'D.K.', role: 'Accredited Participant' },
                { q: "Been running a $100k account since early 2024. Went through some choppy stretches in the market and the risk controls held. Some weeks it barely traded, others it was more active. Fine either way because the account stayed clean and payouts kept coming. Added a second account in month five.", name: 'S.L.', role: 'QS1 Participant since 2024' },
                { q: "Setup took maybe two hours including the prop firm paperwork. I've onboarded into other strategies that took weeks just to get the documentation sorted. First payout was about six weeks after the algo went live. Didn't expect that timeline. Still running it.", name: 'T.M.', role: 'Independent Allocator' },
              ].map((t, i) => (
